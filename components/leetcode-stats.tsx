export async function LeetcodeStats({ username }: { username: string }) {
  ...
  try {
    ...
    return (
      <div className="w-full p-6 rounded-2xl border border-border/40 bg-card/10 backdrop-blur-md flex flex-col gap-4 group hover:border-[#FFA116]/40 transition-colors relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 z-10">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-foreground tracking-tight">LeetCode</span>
