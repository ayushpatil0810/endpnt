  ...
  return (
    <div className="flex flex-col gap-6 lg:gap-8 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Views */}
        <div className="flex flex-col gap-3 p-5 sm:p-6 rounded-2xl bg-card border border-border/40 shadow-sm">
      ...
      {topLinks.length > 0 && totalClicks > 0 && (
        <div className="flex flex-col gap-6 p-6 sm:p-8 rounded-3xl bg-card border border-border/40 shadow-sm">
