...
import { DashboardStoreProvider } from '@/lib/stores/dashboard-store-provider';
...
export default async function DashboardPage() {
	...
	const rawEvents = await db
		...
		.from(events)
		.where(and(eq(events.userId, session.user.id), gte(events.createdAt, thirtyDaysAgo)));
	...
	return (
		<DashboardStoreProvider initialData={initialData}>
